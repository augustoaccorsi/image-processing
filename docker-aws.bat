...
docker tag microservices_database 571785655335.dkr.ecr.sa-east-1.amazonaws.com/database
docker tag microservices_engine 571785655335.dkr.ecr.sa-east-1.amazonaws.com/engine
docker tag postgres 571785655335.dkr.ecr.sa-east-1.amazonaws.com/postgres
docker tag microservices_nginx 571785655335.dkr.ecr.sa-east-1.amazonaws.com/nginx
